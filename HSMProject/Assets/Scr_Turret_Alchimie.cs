...
public class Scr_Turret_Alchimie : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.tag == "Enemy")
        {
            ...
            tr_target = nearestEnemy.transform;
    ...
    void Shoot()
    {
        GameObject bulletGo = (GameObject)Instantiate(bulletPrefab, tr_target.position, tr_target.rotation);
        Scr_Bullet bullet = bulletGo.GetComponent<Scr_Bullet>();

        if (bullet != null && tr_target != null)
            bullet.Seek(tr_target);
    }
